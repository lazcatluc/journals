INSERT INTO user(login_name, email, pwd, enabled, role) VALUES ('publisher1', 'publisher1@example.com', '$2a$10$RC1.YFSL8o2vCIg6kB3fjuBB639BdjY6AD8rIw9oyWJLws/1Q6Lku', TRUE, 'PUBLISHER');
INSERT INTO user(login_name, email, pwd, enabled, role) VALUES ('publisher2', 'publisher2@example.com', '$2a$10$MUahUza86ErCxtsgpmMBDeR5VtoGHioRdl03/jQmkM/sk6L.Eg28e', TRUE, 'PUBLISHER');
INSERT INTO user(login_name, email, pwd, enabled, role) VALUES ('user1', 'lazcatluc@yahoo.com', '$2a$10$WcgRF8VQ8DKt4h4Hz9pWv.6MXnIRmcPr0j9jqsseprsBwTD4w8WSm', TRUE, 'USER');
INSERT INTO user(login_name, email, pwd, enabled, role) VALUES ('user2', 'user2@example.com', '$2a$10$Q5bxyPXhHXFc1fRUMCRWR.GbgsXx9aGZdoEoEAz2JFEfckdyUKfOi', TRUE, 'USER');
